...
passes, calculating the expected number of passes needed to reach a
particular player, and predicting long-term behavior through the
simulation of stochastic processes. Additionally, the steady-state
distribution can estimate how ball possession is likely to be
distributed among players over time. This approach can also highlight a
